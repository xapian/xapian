/** @file brass_record.h
 * @brief Records in brass databases
 */
...
#ifndef OM_HGUARD_BRASS_RECORD_H
#define OM_HGUARD_BRASS_RECORD_H
...
/** A record in a brass database.
 */
class BrassRecordTable : public BrassTable {
    public:
...
#endif /* OM_HGUARD_BRASS_RECORD_H */
