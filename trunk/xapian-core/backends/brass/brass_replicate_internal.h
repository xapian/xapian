/** @file brass_replicate_internal.h
...
#ifndef XAPIAN_INCLUDED_BRASS_REPLICATE_INTERNAL_H
#define XAPIAN_INCLUDED_BRASS_REPLICATE_INTERNAL_H

// Magic string used to recognise a changeset file.
#define CHANGES_MAGIC_STRING "BrassChanges"
...
#endif /* XAPIAN_INCLUDED_BRASS_REPLICATE_INTERNAL_H */
