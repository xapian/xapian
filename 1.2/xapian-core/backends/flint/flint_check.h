/* flint_check.h: Btree checking
 *
 * Copyright 1999,2000,2001 BrightStation PLC
 * Copyright 2002 Ananova Ltd
 * Copyright 2002,2004,2005,2006,2008,2013 Olly Betts
...
#ifndef OM_HGUARD_FLINT_CHECK_H
...
class BtreeCheck : public FlintTable {
	...
	static void check(const char * tablename, const std::string & path,
			  flint_revision_number_t * rev_ptr,
