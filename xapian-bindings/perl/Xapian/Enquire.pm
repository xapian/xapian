...
Xapian::Enquire - Make queries against a database
...
takes either a ready made L<Xapian::Query> or a scalar containing
a query, which in that case will be passed to L<Xapian::Query>'s
