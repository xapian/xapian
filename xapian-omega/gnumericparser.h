...
#ifndef OMEGA_INCLUDED_GNUMERICPARSER_H
#define OMEGA_INCLUDED_GNUMERICPARSER_H

#include "xmlparser.h"

class GnumericParser : public XmlParser {
...
#endif // OMEGA_INCLUDED_GNUMERICPARSER_H
