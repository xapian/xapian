...
#include <jni.h>
/* Header for class com_muscat_om_OmPrefixExpandDecider */

#ifndef _Included_com_muscat_om_OmPrefixExpandDecider
#define _Included_com_muscat_om_OmPrefixExpandDecider
#ifdef __cplusplus
extern "C" {
#endif
/*
