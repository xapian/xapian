...
/** This class implements the IfB2 weighting scheme,which is a representative
 ...
 *
 * For more information about the DFR Framework and the IfB2 scheme, please refer:
...
class XAPIAN_VISIBILITY_DEFAULT IfB2Weight : public Weight {
  ...
  public:
    /** Construct a IfB2Weight.
     *
     *  @param c  A non-negative and non zero parameter controlling the extent
     *            of the normalization of the wdf to the document length. A default
     *            value of 1 is suitable for longer queries but it may need to
     *            be changed for shorter queries. For more information, please refer
     *            to Gianni Amati's PHD thesis titled Probabilistic Models for
     *            Information Retrieval based on Divergence from Randomness.
     */
    explicit IfB2Weight(double c_);
