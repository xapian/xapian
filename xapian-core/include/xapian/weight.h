...
/* Xapian::Weight subclass implementing the tf-idf weighting scheme with various normalizations for
    tf ,idf and the tfidf weight. */
class XAPIAN_VISIBILITY_DEFAULT TfIdfWeight : public Weight {
    /// Three character String indicating the normalizations for tf,idf and tfidf weight
