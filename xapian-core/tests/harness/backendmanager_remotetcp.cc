...
Xapian::Database
BackendManagerRemoteTcp::get_database(const vector<string> & files)
{
...
Xapian::Database
BackendManagerRemoteTcp::get_database(const string & file)
{
    return BackendManagerRemoteTcp::get_database(vector<string>(1, file));
}
