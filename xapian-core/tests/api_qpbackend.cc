...
DEFINE_TESTCASE(qpsynonympartial1, flint) {
    static test test_queries[] = {
	{ "hello", "hello:(pos=1)" },
	{ "~hello", "(hello:(pos=1) OR hi:(pos=1) OR howdy:(pos=1))" },
	{ "hello world", "(hello:(pos=1) OR world:(pos=2))" },
	{ "~hello world", "(hello:(pos=1) OR hi:(pos=1) OR howdy:(pos=1) OR world:(pos=2))" },
	{ "world ~hello", "(world:(pos=1) OR hello:(pos=2) OR hi:(pos=2) OR howdy:(pos=2))" },
	{ NULL, NULL }
    };
