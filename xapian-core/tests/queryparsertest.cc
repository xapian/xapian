...
static test test_or_queries[] = {
    ...
    // Regression test for bug introduced into (and fixed in) SVN prior to 1.0.
    { "author:(title::case)", "(Atitl:(pos=1) PHRASE 2 Acase:(pos=2))" },
    ...
    { "mysql_fetch_row(): supplied argument is not a valid MySQL result resource", "(mysql_fetch_row:(pos=1) OR suppli:(pos=2) OR argument:(pos=3) OR is:(pos=4) OR not:(pos=5) OR a:(pos=6) OR valid:(pos=7) OR Rmysql:(pos=8) OR result:(pos=9) OR resourc:(pos=10))" },
    ...
    { "Request.ServerVariables(\"logon_user\")", "((Rrequest:(pos=1) PHRASE 2 Rservervariables:(pos=2)) OR logon_us:(pos=3))" },
    ...
    { "ip_masq_new(proto=TCP)", "(ip_masq_new:(pos=1) OR proto:(pos=2) OR Rtcp:(pos=3))" },
    ...
    { "\"Ze houden geen rekening met de kwaliteit van AF. Als ze dat gedaan hadden dan waren ze tot de conclusie gekomen dat Performance AF (dus Bilinear AF) op de 9700Pro goed te vergelijken is met Balanced AF op de GFFX. En dan hadden ze ook gezien dat de GFFX niet kan tippen aan de Quality AF van de 9700Pro.\"", "(Rze:(pos=1) PHRASE 59 houden:(pos=2) PHRASE 59 geen:(pos=3) PHRASE 59 reken:(pos=4) PHRASE 59 met:(pos=5) PHRASE 59 de:(pos=6) PHRASE 59 kwaliteit:(pos=7) PHRASE 59 van:(pos=8) PHRASE 59 Raf:(pos=9) PHRASE 59 Rals:(pos=10) PHRASE 59 ze:(pos=11) PHRASE 59 dat:(pos=12) PHRASE 59 gedaan:(pos=13) PHRASE 59 hadden:(pos=14) PHRASE 59 dan:(pos=15) PHRASE 59 waren:(pos=16) PHRASE 59 ze:(pos=17) PHRASE 59 tot:(pos=18) PHRASE 59 de:(pos=19) PHRASE 59 conclusi:(pos=20) PHRASE 59 gekomen:(pos=21) PHRASE 59 dat:(pos=22) PHRASE 59 Rperformance:(pos=23) PHRASE 59 Raf:(pos=24) PHRASE 59 dus:(pos=25) PHRASE 59 Rbilinear:(pos=26) PHRASE 59 Raf:(pos=27) PHRASE 59 op:(pos=28) PHRASE 59 de:(pos=29) PHRASE 59 9700pro:(pos=30) PHRASE 59 go:(pos=31) PHRASE 59 te:(pos=32) PHRASE 59 vergelijken:(pos=33) PHRASE 59 is:(pos=34) PHRASE 59 met:(pos=35) PHRASE 59 Rbalanced:(pos=36) PHRASE 59 Raf:(pos=37) PHRASE 59 op:(pos=38) PHRASE 59 de:(pos=39) PHRASE 59 Rgffx:(pos=40) PHRASE 59 Ren:(pos=41) PHRASE 59 dan:(pos=42) PHRASE 59 hadden:(pos=43) PHRASE 59 ze:(pos=44) PHRASE 59 ook:(pos=45) PHRASE 59 gezien:(pos=46) PHRASE 59 dat:(pos=47) PHRASE 59 de:(pos=48) PHRASE 59 Rgffx:(pos=49) PHRASE 59 niet:(pos=50) PHRASE 59 kan:(pos=51) PHRASE 59 tippen:(pos=52) PHRASE 59 aan:(pos=53) PHRASE 59 de:(pos=54) PHRASE 59 Rquality:(pos=55) PHRASE 59 Raf:(pos=56) PHRASE 59 van:(pos=57) PHRASE 59 de:(pos=58) PHRASE 59 9700pro:(pos=59))" },
    { "$structure = imap_header($mbox, $tt);", "(structur:(pos=1) OR imap_head:(pos=2) OR mbox:(pos=3) OR tt:(pos=4))" },
    ...
    { "ereg_replace(\"\\\\\",\"\\/\"", "ereg_replac:(pos=1)" },
    ...
    { "session_set_cookie_params(echo \"hoi\")", "(session_set_cookie_param:(pos=1) OR echo:(pos=2) OR hoi:(pos=3))" },
    ...
    { "if ($_POST['Submit'])", "(if:(pos=1) OR _post:(pos=2) OR Rsubmit:(pos=3))" },
    { "NEC DVD+-RW ND-1300A", "(Rnec:(pos=1) OR (Rdvd+:(pos=2) PHRASE 2 Rrw:(pos=3)) OR (Rnd:(pos=4) PHRASE 2 1300a:(pos=5)))" },
    ...
    { "href=\"#\"", "href:(pos=1)" },
    { "Request.ServerVariables(\"REMOTE_USER\") javascript", "((Rrequest:(pos=1) PHRASE 2 Rservervariables:(pos=2)) OR Rremote_user:(pos=3) OR javascript:(pos=4))" },
    ...
    { "De lees- of schrijfbewerking (\"written\") op het geheugen is mislukt", "(Rde:(pos=1) OR lee:(pos=2) OR of:(pos=3) OR schrijfbewerk:(pos=4) OR written:(pos=5) OR op:(pos=6) OR het:(pos=7) OR geheugen:(pos=8) OR is:(pos=9) OR mislukt:(pos=10))" },
    ...
    { "ipsec_setup (/etc/ipsec.conf, line 1) cannot open configuration file \"/etc/ipsec.conf\" -- `' aborted", "(ipsec_setup:(pos=1) OR (etc:(pos=2) PHRASE 3 ipsec:(pos=3) PHRASE 3 conf:(pos=4)) OR line:(pos=5) OR 1:(pos=6) OR cannot:(pos=7) OR open:(pos=8) OR configur:(pos=9) OR file:(pos=10) OR (etc:(pos=11) PHRASE 3 ipsec:(pos=12) PHRASE 3 conf:(pos=13)) OR abort:(pos=14))" },
    ...
    { "libc.so.6(GLIBC_2.3)", "((libc:(pos=1) PHRASE 3 so:(pos=2) PHRASE 3 6:(pos=3)) OR (Rglibc_2:(pos=4) PHRASE 2 3:(pos=5)))" },
    ...
    { "ob_start(\"ob_gzhandler\"); file download", "(ob_start:(pos=1) OR ob_gzhandl:(pos=2) OR file:(pos=3) OR download:(pos=4))" },
    ...
    { "setProperty(\"McSquare\"+i, _xscale, _xscale++);", "(setproperti:(pos=1) OR Rmcsquare:(pos=2) OR i:(pos=3) OR _xscale:(pos=4) OR _xscale++:(pos=5))" },
    ...
    { "(php.ini) (memory_limit)", "((php:(pos=1) PHRASE 2 ini:(pos=2)) OR memory_limit:(pos=3))" },
    { "line 8: syntax error near unexpected token `kernel_thread(f'", "(line:(pos=1) OR 8:(pos=2) OR syntax:(pos=3) OR error:(pos=4) OR near:(pos=5) OR unexpect:(pos=6) OR token:(pos=7) OR kernel_thread:(pos=8) OR f:(pos=9))" },
    ...
    { "+=", "" },
    { "php +=", "php:(pos=1)" },
    { "[php] ereg_replace(\".\"", "(php:(pos=1) OR ereg_replac:(pos=2))" },
    ...
    { "for inclusion (include_path='.:/usr/share/php')", "(for:(pos=1) OR inclus:(pos=2) OR include_path:(pos=3) OR (usr:(pos=4) PHRASE 3 share:(pos=5) PHRASE 3 php:(pos=6)))" },
    ...
    { "undefined reference to `mysql_drop_db'\"", "(undefin:(pos=1) OR refer:(pos=2) OR to:(pos=3) OR mysql_drop_db:(pos=4))" },
    ...
    { "ENCAPSED_AND_WHITESPACE", "Rencapsed_and_whitespace:(pos=1)" },
    ...
    { "getenv(\"HTTP_REFERER\")", "(getenv:(pos=1) OR Rhttp_referer:(pos=2))" },
    { "Error setting display mode: CreateDevice failed (D3DERR_DRIVERINTERNALERROR)", "(Rerror:(pos=1) OR set:(pos=2) OR display:(pos=3) OR mode:(pos=4) OR Rcreatedevice:(pos=5) OR fail:(pos=6) OR Rd3derr_driverinternalerror:(pos=7))" },
    ...
    { "parse error, unexpected '\\\"', expecting T_STRING or T_VARIABLE or T_NUM_STRING", "(pars:(pos=1) OR error:(pos=2) OR unexpect:(pos=3) OR (expect:(pos=4) PHRASE 6 Rt_string:(pos=5) PHRASE 6 or:(pos=6) PHRASE 6 Rt_variable:(pos=7) PHRASE 6 or:(pos=8) PHRASE 6 Rt_num_string:(pos=9)))" },
    ...
    { "DATE_FORMAT('1997-10-04 22:23:00', '%W %M %Y');", "(Rdate_format:(pos=1) OR (1997:(pos=2) PHRASE 3 10:(pos=3) PHRASE 3 04:(pos=4)) OR (22:(pos=5) PHRASE 3 23:(pos=6) PHRASE 3 00:(pos=7)) OR Rw:(pos=8) OR Rm:(pos=9) OR Ry:(pos=10))" },
    ...
    { "ob_start(\"ob_gzhandler\");", "(ob_start:(pos=1) OR ob_gzhandl:(pos=2))" },
    ...
    { "COM+-gebeurtenissysteem", "(Rcom+:(pos=1) PHRASE 2 gebeurtenissysteem:(pos=2))" },
    ...
    { "vervangen # /\"", "vervangen:(pos=1)" },
    { "while(list($key, $val) = each($HTTP_POST_VARS))", "(while:(pos=1) OR list:(pos=2) OR key:(pos=3) OR val:(pos=4) OR each:(pos=5) OR Rhttp_post_vars:(pos=6))" },
    ...
    { "preg_replace (.*?)", "preg_replac:(pos=1)" },
    ...
    { "IIS getenv(REMOTE_HOST)_", "(Riis:(pos=1) OR getenv:(pos=2) OR Rremote_host:(pos=3) OR _:(pos=4))" },
    { "IIS en getenv(REMOTE_HOST)", "(Riis:(pos=1) OR en:(pos=2) OR getenv:(pos=3) OR Rremote_host:(pos=4))" },
    { "php getenv(\"HTTP_REFERER\")", "(php:(pos=1) OR getenv:(pos=2) OR Rhttp_referer:(pos=3))" },
    ...
    { "provider+-webspace", "(provider+:(pos=1) PHRASE 2 webspac:(pos=2))" },
    ...
    { "if (mysql_num_rows($resultaat)==1)", "(if:(pos=1) OR mysql_num_row:(pos=2) OR resultaat:(pos=3) OR 1:(pos=4))" },
    ...
    { "remote_smtp defer (-44)", "(remote_smtp:(pos=1) OR defer:(pos=2) OR 44:(pos=3))" },
    ...
    { "Warning: Failed opening for inclusion (include_path='') in Unknown on line 0", "(Rwarning:(pos=1) OR Rfailed:(pos=2) OR open:(pos=3) OR for:(pos=4) OR inclus:(pos=5) OR include_path:(pos=6) OR in:(pos=7) OR Runknown:(pos=8) OR on:(pos=9) OR line:(pos=10) OR 0:(pos=11))" },
    { "\"~\" + \"c:\\\"", "c:(pos=1)" },
    ...
    { "session_register(\"login\");", "(session_regist:(pos=1) OR login:(pos=2))" },
    ...
    { "If ($_SESSION[\"Login\"] == 1)", "(Rif:(pos=1) OR _session:(pos=2) OR Rlogin:(pos=3) OR 1:(pos=4))" },
    ...
    { "IRQL_NOT_LESS_OR_EQUAL", "Rirql_not_less_or_equal:(pos=1)" },
