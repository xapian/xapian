...
static const test test_or_queries[] = {
    ...
    { "2.5\" harddisk converter", "(2.5@1 OR (harddisk@2 PHRASE 2 converter@3))" }, // FIXME better if " didn't generate a phrase here...
    ...
    { "nec dvd -/+r", "((Znec@1 OR Zdvd@2) AND_NOT Zr@3)" }, // Not ideal at all - "-" shouldn't fire here...
    ...
    { "\"phrase one \"phrase two\"", "((phrase@1 PHRASE 2 one@2) OR Zphrase@3 OR two@4)" }, // FIXME: 2 phrases better?
    ...
    { "authortitle:richard NEAR title:book", "((Arichard@1 NEAR 11 XTbook@2) OR (XTrichard@1 NEAR 11 XTbook@2))"},
