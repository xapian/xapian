...
static test test_or_queries[] = {
    ...
    { "553 sorry, that domain isn't in my list of allowed rcpthosts (#5.7.1)", "(553:(pos=1) OR Zsorri:(pos=2) OR Zthat:(pos=3) OR Zdomain:(pos=4) OR Zisn't:(pos=5) OR Zin:(pos=6) OR Zmy:(pos=7) OR Zlist:(pos=8) OR Zof:(pos=9) OR Zallow:(pos=10) OR Zrcpthost:(pos=11) OR (5:(pos=12) PHRASE 3 7:(pos=13) PHRASE 3 1:(pos=14)))" },
    ...
    { "*** stop: 0x0000001E (0xC0000005,0x00000000,0x00000000,0x00000000)", "(Zstop:(pos=1) OR 0x0000001e:(pos=2) OR 0xc0000005:(pos=3) OR 0x00000000:(pos=4) OR 0x00000000:(pos=5) OR 0x00000000:(pos=6))" },
    ...
    { "xp 5.1.2600.0 (xpclient.010817-1148)", "(Zxp:(pos=1) OR (5:(pos=2) PHRASE 4 1:(pos=3) PHRASE 4 2600:(pos=4) PHRASE 4 0:(pos=5)) OR (xpclient:(pos=6) PHRASE 3 010817:(pos=7) PHRASE 3 1148:(pos=8)))" },
    ...
    { "2.5\" harddisk converter", "((2:(pos=1) PHRASE 2 5:(pos=2)) OR (harddisk:(pos=3) PHRASE 2 converter:(pos=4)))" }, // FIXME better if " didn't generate a phrase here...
    ...
    { "Compaq HP, 146.8 GB (MPN-286716-B22) Hard Drives", "(compaq:(pos=1) OR hp:(pos=2) OR (146:(pos=3) PHRASE 2 8:(pos=4)) OR gb:(pos=5) OR (mpn:(pos=6) PHRASE 3 286716:(pos=7) PHRASE 3 b22:(pos=8)) OR hard:(pos=9) OR drives:(pos=10))" },
    ...
    { "libc.so.6(GLIBC_2.3)", "((libc:(pos=1) PHRASE 3 so:(pos=2) PHRASE 3 6:(pos=3)) OR (glibc_2:(pos=4) PHRASE 2 3:(pos=5)))" },
    ...
    { "bluetooth '1.3.2.19\"", "(Zbluetooth:(pos=1) OR (1:(pos=2) PHRASE 4 3:(pos=3) PHRASE 4 2:(pos=4) PHRASE 4 19:(pos=5)))" },
    ...
    { "ULTRA PC-TUNING, COOLING & MODDING (4,6)", "(ultra:(pos=1) OR (pc:(pos=2) PHRASE 2 tuning:(pos=3)) OR cooling:(pos=4) OR modding:(pos=5) OR 4:(pos=6) OR 6:(pos=7))" },
    ...
    { "Arctic Super Silent PRO TC (Athlon/P3 - 2,3 GHz)", "(arctic:(pos=1) OR super:(pos=2) OR silent:(pos=3) OR pro:(pos=4) OR tc:(pos=5) OR (athlon:(pos=6) PHRASE 2 p3:(pos=7)) OR 2:(pos=8) OR 3:(pos=9) OR ghz:(pos=10))" },
    ...
    { "AMD Athlon XP 2500+ (1,83GHz, 512KB)", "(amd:(pos=1) OR athlon:(pos=2) OR xp:(pos=3) OR 2500+:(pos=4) OR 1:(pos=5) OR 83ghz:(pos=6) OR 512kb:(pos=7))" },
    ...
    { "Qt (>= Qt 3.0.3) (library qt-mt) not found", "(qt:(pos=1) OR qt:(pos=2) OR (3:(pos=3) PHRASE 3 0:(pos=4) PHRASE 3 3:(pos=5)) OR Zlibrari:(pos=6) OR (qt:(pos=7) PHRASE 2 mt:(pos=8)) OR Znot:(pos=9) OR Zfound:(pos=10))" },
    ...
    { "EPOX EP-8RDA+ (nForce2 SPP+MCP-T) Rev. 1.1", "(epox:(pos=1) OR (ep:(pos=2) PHRASE 2 8rda+:(pos=3)) OR Znforce2:(pos=4) OR spp:(pos=5) OR (mcp:(pos=6) PHRASE 2 t:(pos=7)) OR rev:(pos=8) OR (1:(pos=9) PHRASE 2 1:(pos=10)))" },
    { "554 5.4.6 Too many hops 53 (25 max)", "(554:(pos=1) OR (5:(pos=2) PHRASE 3 4:(pos=3) PHRASE 3 6:(pos=4)) OR too:(pos=5) OR Zmani:(pos=6) OR Zhop:(pos=7) OR 53:(pos=8) OR 25:(pos=9) OR Zmax:(pos=10))" },
    { "ik had toch nog een vraagje: er zijn nu eigenlijk alleen maar schijfjes van 4.7GB alleen straks zullen er vast schijfjes van meer dan 4.7GB komen. Zal deze brander dit wel kunnen schijven?" "?(na bijvoorbeeld een firmware update?) ben erg benieuwd", "(Zik:(pos=1) OR Zhad:(pos=2) OR Ztoch:(pos=3) OR Znog:(pos=4) OR Zeen:(pos=5) OR Zvraagj:(pos=6) OR Zer:(pos=7) OR Zzijn:(pos=8) OR Znu:(pos=9) OR Zeigenlijk:(pos=10) OR Zalleen:(pos=11) OR Zmaar:(pos=12) OR Zschijfj:(pos=13) OR Zvan:(pos=14) OR (4:(pos=15) PHRASE 2 7gb:(pos=16)) OR Zalleen:(pos=17) OR Zstrak:(pos=18) OR Zzullen:(pos=19) OR Zer:(pos=20) OR Zvast:(pos=21) OR Zschijfj:(pos=22) OR Zvan:(pos=23) OR Zmeer:(pos=24) OR Zdan:(pos=25) OR (4:(pos=26) PHRASE 2 7gb:(pos=27)) OR Zkomen:(pos=28) OR zal:(pos=29) OR Zdeze:(pos=30) OR Zbrander:(pos=31) OR Zdit:(pos=32) OR Zwel:(pos=33) OR Zkunnen:(pos=34) OR Zschijven:(pos=35) OR Zna:(pos=36) OR Zbijvoorbeeld:(pos=37) OR Zeen:(pos=38) OR Zfirmwar:(pos=39) OR Zupdat:(pos=40) OR Zben:(pos=41) OR Zerg:(pos=42) OR Zbenieuwd:(pos=43))" }, // Split ? and ? to avoid trigram problems
    { "ati linux drivers (4.3.0)", "(Zati:(pos=1) OR Zlinux:(pos=2) OR Zdriver:(pos=3) OR (4:(pos=4) PHRASE 3 3:(pos=5) PHRASE 3 0:(pos=6)))" },
    ...
    { "checking for Qt... configure: error: Qt (>= Qt 3.0.2) (headers and libraries) not found. Please check your installation!", "(Zcheck:(pos=1) OR Zfor:(pos=2) OR qt:(pos=3) OR Zconfigur:(pos=4) OR Zerror:(pos=5) OR qt:(pos=6) OR qt:(pos=7) OR (3:(pos=8) PHRASE 3 0:(pos=9) PHRASE 3 2:(pos=10)) OR Zheader:(pos=11) OR Zand:(pos=12) OR Zlibrari:(pos=13) OR Znot:(pos=14) OR Zfound:(pos=15) OR please:(pos=16) OR Zcheck:(pos=17) OR Zyour:(pos=18) OR Zinstal:(pos=19))" },
    ...
    { "502 Permission Denied - Permission Denied - news.chello.nl -- http://www.chello.nl/ (Typhoon v1.2.3)", "(502:(pos=1) OR permission:(pos=2) OR denied:(pos=3) OR permission:(pos=4) OR denied:(pos=5) OR (news:(pos=6) PHRASE 3 chello:(pos=7) PHRASE 3 nl:(pos=8)) OR (http:(pos=9) PHRASE 4 www:(pos=10) PHRASE 4 chello:(pos=11) PHRASE 4 nl:(pos=12)) OR typhoon:(pos=13) OR (v1:(pos=14) PHRASE 3 2:(pos=15) PHRASE 3 3:(pos=16)))" },
    ...
    { "rcpthosts (#5.7.1)", "(Zrcpthost:(pos=1) OR (5:(pos=2) PHRASE 3 7:(pos=3) PHRASE 3 1:(pos=4)))" },
    ...
    { "error: Qt-1.4 (headers and libraries) not found. Please check your installation!", "(Zerror:(pos=1) OR (qt:(pos=2) PHRASE 3 1:(pos=3) PHRASE 3 4:(pos=4)) OR Zheader:(pos=5) OR Zand:(pos=6) OR Zlibrari:(pos=7) OR Znot:(pos=8) OR Zfound:(pos=9) OR please:(pos=10) OR Zcheck:(pos=11) OR Zyour:(pos=12) OR Zinstal:(pos=13))" },
    ...
    { "Abit NF7-S (nForce 2 Chipset) Rev 2.0", "(abit:(pos=1) OR (nf7:(pos=2) PHRASE 2 s:(pos=3)) OR Znforc:(pos=4) OR 2:(pos=5) OR chipset:(pos=6) OR rev:(pos=7) OR (2:(pos=8) PHRASE 2 0:(pos=9)))" },
    ...
    { "(Windows; U; Windows NT 5.1; en-US; rv:1.3b) Gecko/20030210", "(windows:(pos=1) OR u:(pos=2) OR windows:(pos=3) OR nt:(pos=4) OR (5:(pos=5) PHRASE 2 1:(pos=6)) OR (en:(pos=7) PHRASE 2 us:(pos=8)) OR (rv:(pos=9) PHRASE 3 1:(pos=10) PHRASE 3 3b:(pos=11)) OR (gecko:(pos=12) PHRASE 2 20030210:(pos=13)))" },
    { "en-US; rv:1.3b) Gecko/20030210", "((en:(pos=1) PHRASE 2 us:(pos=2)) OR (rv:(pos=3) PHRASE 3 1:(pos=4) PHRASE 3 3b:(pos=5)) OR (gecko:(pos=6) PHRASE 2 20030210:(pos=7)))" },
    { "\"en-US; rv:1.3b) Gecko/20030210\"", "(en:(pos=1) PHRASE 7 us:(pos=2) PHRASE 7 rv:(pos=3) PHRASE 7 1:(pos=4) PHRASE 7 3b:(pos=5) PHRASE 7 gecko:(pos=6) PHRASE 7 20030210:(pos=7))" },
    ...
    { "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01//EN\"> document.body.scrollHeight", "(doctype:(pos=1) OR html:(pos=2) OR public:(pos=3) OR (w3c:(pos=4) PHRASE 6 dtd:(pos=5) PHRASE 6 html:(pos=6) PHRASE 6 4:(pos=7) PHRASE 6 01:(pos=8) PHRASE 6 en:(pos=9)) OR (document:(pos=10) PHRASE 3 body:(pos=11) PHRASE 3 scrollheight:(pos=12)))" },
    ...
    { "GA-7VRXP(2.0)", "((ga:(pos=1) PHRASE 2 7vrxp:(pos=2)) OR (2:(pos=3) PHRASE 2 0:(pos=4)))" },
