...
static test tests[] = {
    ...
    { "553 sorry, that domain isn't in my list of allowed rcpthosts (#5.7.1)",
      "(553:(pos=1) OR sorri:(pos=2) OR that:(pos=3) OR domain:(pos=4) OR isn:(pos=5) OR t:(pos=6) OR in:(pos=7) OR my:(pos=8) OR list:(pos=9) OR of:(pos=10) OR allow:(pos=11) OR rcpthost:(pos=12) OR (5:(pos=13) PHRASE 3 7:(pos=14) PHRASE 3 1:(pos=15)))" },
    ...
    { "Request.ServerVariables(\"logon_user\")", "((Rrequest:(pos=1) PHRASE 2 Rservervariables:(pos=2)) OR logon:(pos=3) OR user:(pos=4))" },
    { "ASP \"request.form\" van \\\"enctype=\"MULTIPART/FORM-DATA\"\\\"",
      "(Rasp:(pos=1) OR (request:(pos=2) PHRASE 2 form:(pos=3)) OR van:(pos=4) OR enctyp:(pos=5) OR Rmultipart:(pos=6) OR Rform:(pos=7) OR Rdata:(pos=8))" },
    ...
    { "xp 5.1.2600.0 (xpclient.010817-1148)", "(xp:(pos=1) OR (5:(pos=2) PHRASE 4 1:(pos=3) PHRASE 4 2600:(pos=4) PHRASE 4 0:(pos=5)) OR (xpclient:(pos=6) PHRASE 2 010817:(pos=7)) OR 1148:(pos=8))" },
    ...
    { "href=\"#\"", "href:(pos=1)" },
    { "Request.ServerVariables(\"REMOTE_USER\") javascript", "((Rrequest:(pos=1) PHRASE 2 Rservervariables:(pos=2)) OR Rremote:(pos=3) OR Ruser:(pos=4) OR javascript:(pos=5))" },
    ...
    { "The Jet VBA file (VBAJET.dll for 16-bit version, VBAJET32.dll version", "(Rthe:(pos=1) OR Rjet:(pos=2) OR Rvba:(pos=3) OR file:(pos=4) OR (Rvbajet:(pos=5) PHRASE 2 dll:(pos=6)) OR for:(pos=7) OR 16:(pos=8) OR bit:(pos=9) OR version:(pos=10) OR (Rvbajet32:(pos=11) PHRASE 2 dll:(pos=12)) OR version:(pos=13))" },
    ...
    { "2.5\\\"harddisk converter", "((2:(pos=1) PHRASE 2 5:(pos=2)) OR harddisk:(pos=3) OR convert:(pos=4))" },
    ...
    { "\"libstdc++-libc6.1-1.so.2\"", "(libstdc:(pos=1) OR (libc6:(pos=2) PHRASE 2 1:(pos=3)) OR (1:(pos=4) PHRASE 3 so:(pos=5) PHRASE 3 2:(pos=6)))" },
    { "ipsec_setup (/etc/ipsec.conf, line 1) cannot open configuration file \"/etc/ipsec.conf\" -- `' aborted", "(ipsec:(pos=1) OR setup:(pos=2) OR etc:(pos=3) OR (ipsec:(pos=4) PHRASE 2 conf:(pos=5)) OR line:(pos=6) OR 1:(pos=7) OR cannot:(pos=8) OR open:(pos=9) OR configur:(pos=10) OR file:(pos=11) OR etc:(pos=12) OR (ipsec:(pos=13) PHRASE 2 conf:(pos=14)) OR abort:(pos=15))" },
    ...
    { "Compaq HP, 146.8 GB (MPN-286716-B22) Hard Drives", "(Rcompaq:(pos=1) OR Rhp:(pos=2) OR (146:(pos=3) PHRASE 2 8:(pos=4)) OR Rgb:(pos=5) OR Rmpn:(pos=6) OR 286716:(pos=7) OR Rb22:(pos=8) OR Rhard:(pos=9) OR Rdrives:(pos=10))" },
    ...
    { "libc.so.6(GLIBC_2.3)", "((libc:(pos=1) PHRASE 3 so:(pos=2) PHRASE 3 6:(pos=3)) OR Rglibc:(pos=4) OR (2:(pos=5) PHRASE 2 3:(pos=6)))" },
    ...
    { "Javascript:history.go(-1)", "(Rjavascript:(pos=1) OR (histori:(pos=2) PHRASE 2 go:(pos=3)) OR 1:(pos=4))" },
    ...
    { "[warn] Apache does not support line-end comments. Consider using quotes around argument: \"#-1\"", "(warn:(pos=1) OR Rapache:(pos=2) OR doe:(pos=3) OR not:(pos=4) OR support:(pos=5) OR line:(pos=6) OR end:(pos=7) OR comments:(pos=8) OR Rconsider:(pos=9) OR use:(pos=10) OR quot:(pos=11) OR around:(pos=12) OR argument:(pos=13) OR 1:(pos=14))" },
    { "(php.ini) (memory_limit)", "((php:(pos=1) PHRASE 2 ini:(pos=2)) OR memori:(pos=3) OR limit:(pos=4))" },
    ...
    { "include id.Today's date is: <? print (date (\"M d, Y\")); ?>hp", "(includ:(pos=1) OR (id:(pos=2) PHRASE 2 Rtoday:(pos=3)) OR s:(pos=4) OR date:(pos=5) OR is:(pos=6) OR print:(pos=7) OR date:(pos=8) OR Rm:(pos=9) OR d:(pos=10) OR Ry:(pos=11) OR hp:(pos=12))" },
    ...
    { "\"scandisk + dos5.0", "(scandisk:(pos=1) OR (dos5:(pos=2) PHRASE 2 0:(pos=3)))" },
    { "socket\\(\\)", "socket:(pos=1)" },
    ...
    { "specs: IBM PS/2, Intel 8086 @ 25 mhz!!, 2 mb intern, 50 mb hd, 5.5\" floppy drive, toetsenbord en geen muis", "(spec:(pos=1) OR Ribm:(pos=2) OR Rps:(pos=3) OR 2:(pos=4) OR Rintel:(pos=5) OR 8086:(pos=6) OR 25:(pos=7) OR mhz:(pos=8) OR 2:(pos=9) OR mb:(pos=10) OR intern:(pos=11) OR 50:(pos=12) OR mb:(pos=13) OR hd:(pos=14) OR (5:(pos=15) PHRASE 2 5:(pos=16)) OR floppi:(pos=17) OR drive:(pos=18) OR toetsenbord:(pos=19) OR en:(pos=20) OR geen:(pos=21) OR mui:(pos=22))" },
    { "History: GetEventTool <- GetMusicManager <- GetMusicScript <- DMCallRoutine <- AMusicScriptEvent::execCallRoutine <- UObject::execClassContext <- (U2GameInfo M08A1.U2GameInfo0 @ Function U2.U2GameInfo.NotifyLevelChangeEnd : 0075 line 744) <- UObject::ProcessEvent <- (U2GameInfo M08A1.U2GameInfo0, Function U2.U2GameInfo.NotifyLevelChangeEnd) <- UGameEngine::LoadMap <- LocalMapURL <- UGameEngine::Browse <- ServerTravel <- UGameEngine::Tick <- UpdateWorld <- MainLoop", "(Rhistory:(pos=1) OR Rgeteventtool:(pos=2) OR Rgetmusicmanager:(pos=3) OR Rgetmusicscript:(pos=4) OR Rdmcallroutine:(pos=5) OR Ramusicscriptevent:(pos=6) OR execcallroutin:(pos=7) OR Ruobject:(pos=8) OR execclasscontext:(pos=9) OR Ru2gameinfo:(pos=10) OR (Rm08a1:(pos=11) PHRASE 2 Ru2gameinfo0:(pos=12)) OR Rfunction:(pos=13) OR (Ru2:(pos=14) PHRASE 3 Ru2gameinfo:(pos=15) PHRASE 3 Rnotifylevelchangeend:(pos=16)) OR 0075:(pos=17) OR line:(pos=18) OR 744:(pos=19) OR Ruobject:(pos=20) OR Rprocessevent:(pos=21) OR Ru2gameinfo:(pos=22) OR (Rm08a1:(pos=23) PHRASE 2 Ru2gameinfo0:(pos=24)) OR Rfunction:(pos=25) OR (Ru2:(pos=26) PHRASE 3 Ru2gameinfo:(pos=27) PHRASE 3 Rnotifylevelchangeend:(pos=28)) OR Rugameengine:(pos=29) OR Rloadmap:(pos=30) OR Rlocalmapurl:(pos=31) OR Rugameengine:(pos=32) OR Rbrowse:(pos=33) OR Rservertravel:(pos=34) OR Rugameengine:(pos=35) OR Rtick:(pos=36) OR Rupdateworld:(pos=37) OR Rmainloop:(pos=38))" },
    ...
    { "Qt (>= Qt 3.0.3) (library qt-mt) not found", "(Rqt:(pos=1) OR Rqt:(pos=2) OR (3:(pos=3) PHRASE 3 0:(pos=4) PHRASE 3 3:(pos=5)) OR librari:(pos=6) OR qt:(pos=7) OR mt:(pos=8) OR not:(pos=9) OR found:(pos=10))" },
    ...
    { "EPOX EP-8RDA+ (nForce2 SPP+MCP-T) Rev. 1.1", "(Repox:(pos=1) OR Rep:(pos=2) OR 8rda:(pos=3) OR nforce2:(pos=4) OR Rspp:(pos=5) OR Rmcp:(pos=6) OR Rt:(pos=7) OR Rrev:(pos=8) OR (1:(pos=9) PHRASE 2 1:(pos=10)))" },
    ...
    { "Warning: stat failed for /mnt/web/react/got/react/board/non-www/headlines/tnet-headlines.txt (errno=2 - No such file or directory) in /mnt/web/react/got/react/global/non-www/templates/got/functions.inc.php on line 303", "(Rwarning:(pos=1) OR stat:(pos=2) OR fail:(pos=3) OR for:(pos=4) OR mnt:(pos=5) OR web:(pos=6) OR react:(pos=7) OR got:(pos=8) OR react:(pos=9) OR board:(pos=10) OR non:(pos=11) OR www:(pos=12) OR headlin:(pos=13) OR tnet:(pos=14) OR (headlin:(pos=15) PHRASE 2 txt:(pos=16)) OR errno:(pos=17) OR 2:(pos=18) OR Rno:(pos=19) OR such:(pos=20) OR file:(pos=21) OR or:(pos=22) OR directori:(pos=23) OR in:(pos=24) OR mnt:(pos=25) OR web:(pos=26) OR react:(pos=27) OR got:(pos=28) OR react:(pos=29) OR global:(pos=30) OR non:(pos=31) OR www:(pos=32) OR templat:(pos=33) OR got:(pos=34) OR (function:(pos=35) PHRASE 3 inc:(pos=36) PHRASE 3 php:(pos=37)) OR on:(pos=38) OR line:(pos=39) OR 303:(pos=40))" },
    ...
    { "GA-8IHXP(3.0)", "(Rga:(pos=1) OR 8ihxp:(pos=2) OR (3:(pos=3) PHRASE 2 0:(pos=4)))" },
    ...
    { "502 Permission Denied - Permission Denied - news.chello.nl -- http://www.chello.nl/ (Typhoon v1.2.3)", "(502:(pos=1) OR Rpermission:(pos=2) OR Rdenied:(pos=3) OR Rpermission:(pos=4) OR Rdenied:(pos=5) OR (news:(pos=6) PHRASE 3 chello:(pos=7) PHRASE 3 nl:(pos=8)) OR http:(pos=9) OR (www:(pos=10) PHRASE 3 chello:(pos=11) PHRASE 3 nl:(pos=12)) OR Rtyphoon:(pos=13) OR (v1:(pos=14) PHRASE 3 2:(pos=15) PHRASE 3 3:(pos=16)))" },
    ...
    { "Geef de naam van de MSDOS prompt op C:\\\\WINDOWS.COM\\\"", "(Rgeef:(pos=1) OR de:(pos=2) OR naam:(pos=3) OR van:(pos=4) OR de:(pos=5) OR Rmsdos:(pos=6) OR prompt:(pos=7) OR op:(pos=8) OR Rc:(pos=9) OR (Rwindows:(pos=10) PHRASE 2 Rcom:(pos=11)))" },
    ...
    { "LoadLibrary(\"mainta/gamex86.dll\") failed", "(Rloadlibrary:(pos=1) OR mainta:(pos=2) OR (gamex86:(pos=3) PHRASE 2 dll:(pos=4)) OR fail:(pos=5))" },
    ...
    { "\"Postal2+Explorer.exe\"",
"(Rpostal2:(pos=1) OR (Rexplorer:(pos=2) PHRASE 2 exe:(pos=3)))" },
    { "COUNT(*)", "Rcount:(pos=1)" },
    ...
    { "\"www.historical-fire-engines", "((www:(pos=1) PHRASE 2 histor:(pos=2)) OR fire:(pos=3) OR engin:(pos=4))" },
    ...
    { "error: Qt-1.4 (headers and libraries) not found. Please check your installation!", "(error:(pos=1) OR Rqt:(pos=2) OR (1:(pos=3) PHRASE 2 4:(pos=4)) OR header:(pos=5) OR and:(pos=6) OR librari:(pos=7) OR not:(pos=8) OR found:(pos=9) OR Rplease:(pos=10) OR check:(pos=11) OR your:(pos=12) OR instal:(pos=13))" },
    ...
    { "Abit NF7-S (nForce 2 Chipset) Rev 2.0", "(Rabit:(pos=1) OR Rnf7:(pos=2) OR Rs:(pos=3) OR nforc:(pos=4) OR 2:(pos=5) OR Rchipset:(pos=6) OR Rrev:(pos=7) OR (2:(pos=8) PHRASE 2 0:(pos=9)))" },
    ...
    { "<iframe src=\"www.tweakers.net></iframe>", "(ifram:(pos=1) OR src:(pos=2) OR (www:(pos=3) PHRASE 3 tweaker:(pos=4) PHRASE 3 net:(pos=5)) OR ifram:(pos=6))" },
    ...
    { "(Windows; U; Windows NT 5.1; en-US; rv:1.3b) Gecko/20030210", "(Rwindows:(pos=1) OR Ru:(pos=2) OR Rwindows:(pos=3) OR Rnt:(pos=4) OR (5:(pos=5) PHRASE 2 1:(pos=6)) OR en:(pos=7) OR Rus:(pos=8) OR rv:(pos=9) OR (1:(pos=10) PHRASE 2 3b:(pos=11)) OR Rgecko:(pos=12) OR 20030210:(pos=13))" },
    { "en-US; rv:1.3b) Gecko/20030210", "(en:(pos=1) OR Rus:(pos=2) OR rv:(pos=3) OR (1:(pos=4) PHRASE 2 3b:(pos=5)) OR Rgecko:(pos=6) OR 20030210:(pos=7))" },
    { "\"en-US; rv:1.3b) Gecko/20030210\"", "(en:(pos=1) OR Rus:(pos=2) OR rv:(pos=3) OR (1:(pos=4) PHRASE 2 3b:(pos=5)) OR Rgecko:(pos=6) OR 20030210:(pos=7))" },
    ...
    { "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01//EN\"> document.body.scrollHeight", "(Rdoctype:(pos=1) OR Rhtml:(pos=2) OR Rpublic:(pos=3) OR Rw3c:(pos=4) OR Rdtd:(pos=5) OR Rhtml:(pos=6) OR (4:(pos=7) PHRASE 2 01:(pos=8)) OR Ren:(pos=9) OR (document:(pos=10) PHRASE 3 bodi:(pos=11) PHRASE 3 scrollheight:(pos=12)))" },
    ...
    { "Cor \\(CCN\\)'\" <cor.kloet@ccn.controlec.nl>", "(Rcor:(pos=1) OR Rccn:(pos=2) OR (cor:(pos=3) PHRASE 2 kloet:(pos=4)) OR (ccn:(pos=5) PHRASE 3 controlec:(pos=6) PHRASE 3 nl:(pos=7)))" },
    ...
    { "GA-7VRXP(2.0)", "(Rga:(pos=1) OR 7vrxp:(pos=2) OR (2:(pos=3) PHRASE 2 0:(pos=4)))" },
    ...
    { "De lees- of schrijfbewerking (\"written\") op het geheugen is mislukt.", "(Rde:(pos=1) OR lee:(pos=2) OR of:(pos=3) OR schrijfbewerk:(pos=4) OR written:(pos=5) OR op:(pos=6) OR het:(pos=7) OR geheugen:(pos=8) OR is:(pos=9) OR mislukt:(pos=10))" },
    { "putStr (map (\\x -> chr (round (21/2 * x^3 - 92 * x^2 + 503/2 * x - 105))) [1..4])", "(putstr:(pos=1) OR map:(pos=2) OR x:(pos=3) OR chr:(pos=4) OR round:(pos=5) OR 21:(pos=6) OR 2:(pos=7) OR x:(pos=8) OR 3:(pos=9) OR 92:(pos=10) OR x:(pos=11) OR 2:(pos=12) OR 503:(pos=13) OR 2:(pos=14) OR x:(pos=15) OR 105:(pos=16) OR (1:(pos=17) PHRASE 2 4:(pos=18)))" },
    ...
    { "Cannot find imap library (libc-client.a).", "(Rcannot:(pos=1) OR find:(pos=2) OR imap:(pos=3) OR librari:(pos=4) OR libc:(pos=5) OR (client:(pos=6) PHRASE 2 a:(pos=7)))" },
