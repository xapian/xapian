...
extern int snowball_swedish_stem(struct SN_env * z);
...
extern struct SN_env * snowball_swedish_create_env(void) { return SN_create_env(0, 1, 0); }

extern void snowball_swedish_close_env(struct SN_env * z) { SN_close_env(z); }
