...
extern int snowball_finnish_stem(struct SN_env * z);
...
extern struct SN_env * snowball_finnish_create_env(void) { return SN_create_env(1, 2, 1); }

extern void snowball_finnish_close_env(struct SN_env * z) { SN_close_env(z); }
