/* stem_german.h: header for german stemming algorithm.
 *
 * ----START-LICENCE----
...
#ifndef OM_HGUARD_STEM_GERMAN_H
#define OM_HGUARD_STEM_GERMAN_H
...
/* To set up the german_stemming process:
   ...
   to use it:
       ...
       const char * p = german_stem(z, q, i0, i1);
