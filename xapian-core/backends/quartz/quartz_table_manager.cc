...
void
QuartzDiskTableManager::reopen_tables_because_overwritten()
{
    if (readonly) {
	open_tables_consistent();
    } else {
...
void
QuartzBufferedTableManager::reopen_tables_because_overwritten()
{
    disktables.reopen_tables_because_overwritten();
}
