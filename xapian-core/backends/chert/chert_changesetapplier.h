/** @file chert_changesetapplier.h
 * @brief Apply changesets to chert databases.
 */
...
#ifndef XAPIAN_INCLUDED_CHERT_CHANGESETAPPLIER_H
#define XAPIAN_INCLUDED_CHERT_CHANGESETAPPLIER_H

#include "chert_types.h"
#include <string>

class ChertChangesetApplier {
    int fd;
  public:

    /** Create a new ChertChangesetApplier object.
     *
     ...
     *  place of the original database.  Therefore, the ChertChangesetApplier
...
#endif // XAPIAN_INCLUDED_CHERT_CHANGESETAPPLIER_H
