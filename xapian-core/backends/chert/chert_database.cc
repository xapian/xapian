...
bool
ChertDatabase::check_revision_at_least(const string & rev,
				       const string & target) const
{
    DEBUGCALL(DB, bool, "ChertDatabase::check_revision_at_least",
	      rev << ", " << target);
...
void
ChertDatabase::process_changeset_chunk_base(const string & tablename,
					    string & buf,
...
void
ChertDatabase::process_changeset_chunk_blocks(const string & tablename,
					      string & buf,
					      RemoteConnection & conn,
					      const OmTime & end_time)
{
...
string
ChertDatabase::apply_changeset_from_conn(RemoteConnection & conn,
					 const OmTime & end_time)
{
    DEBUGCALL(DB, string, "ChertDatabase::apply_changeset_from_conn",
	      "conn, end_time");
