...
#ifndef XAPIAN_INCLUDED_CHERT_IO_H
#define XAPIAN_INCLUDED_CHERT_IO_H
 ...
 */
inline bool chert_io_sync(int fd)
{
#ifdef F_FULLFSYNC
    ...
    return _commit(fd) == 0;
#else
# error Cannot implement chert_io_sync() without fdatasync(), fsync(), or _commit()
#endif
}
