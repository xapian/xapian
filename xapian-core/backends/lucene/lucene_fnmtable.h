 ...
 *    and zero for fields without term vectors. -- has_term_vector
...
class LuceneFnmTable {
  ...
  public:
     ...
     *  FIXME, field number should be non-negative, so use unsigned 
     *  int instead
     */
