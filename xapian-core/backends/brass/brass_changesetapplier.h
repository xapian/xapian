/** @file brass_changesetapplier.h
 * @brief Apply changesets to brass databases.
 */
...
#ifndef XAPIAN_INCLUDED_BRASS_CHANGESETAPPLIER_H
#define XAPIAN_INCLUDED_BRASS_CHANGESETAPPLIER_H

#include "brass_types.h"
#include <string>

class BrassChangesetApplier {
    int fd;
  public:

    /** Create a new BrassChangesetApplier object.
     *
     ...
     *  place of the original database.  Therefore, the BrassChangesetApplier
...
#endif // XAPIAN_INCLUDED_BRASS_CHANGESETAPPLIER_H
