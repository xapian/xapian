...
#ifndef XAPIAN_INCLUDED_BRASS_DOCDATA_H
#define XAPIAN_INCLUDED_BRASS_DOCDATA_H
...
class BrassDocDataTable : public BrassLazyTable {
  public:
    ...
    /** Create a new BrassDocDataTable object.
     *
     ...
     */
    BrassDocDataTable(const std::string & dbdir, bool readonly)
	: BrassLazyTable("docdata", dbdir + "/docdata.", readonly,
			 Z_DEFAULT_STRATEGY) { }
...
#endif // XAPIAN_INCLUDED_BRASS_DOCDATA_H
