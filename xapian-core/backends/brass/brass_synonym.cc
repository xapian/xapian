...
void
BrassSynonymTable::merge_changes()
{
...
void
BrassSynonymTable::add_synonym(const string & term, const string & synonym)
{
    if (last_term != term) {
	merge_changes();
	last_term = term;
...
void
BrassSynonymTable::remove_synonym(const string & term, const string & synonym)
{
    if (last_term != term) {
	merge_changes();
	last_term = term;
...
void
BrassSynonymTable::clear_synonyms(const string & term)
{
...
TermList *
BrassSynonymTable::open_termlist(const string & term)
{
...
Xapian::doccount
BrassSynonymTermList::get_termfreq() const
{
    throw Xapian::InvalidOperationError("BrassSynonymTermList::get_termfreq() not meaningful");
}

Xapian::termcount
BrassSynonymTermList::get_collection_freq() const
{
    throw Xapian::InvalidOperationError("BrassSynonymTermList::get_collection_freq() not meaningful");
}
