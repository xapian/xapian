 ...
 * Copyright 2002,2004,2005,2006,2008,2009,2010 Olly Betts
...
class BrassTableCheck : public BrassTable {
	...
	void block_check(BrassCBlock * C_, int j, int opts);
	...
	void report_cursor(int N, const BrassCBlock *C_) const;
