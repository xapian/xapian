...
void
BrassValueManager::add_value(Xapian::docid did, Xapian::valueno slot,
			     const string & val)
{
...
void
BrassValueManager::remove_value(Xapian::docid did, Xapian::valueno slot)
{
    map<Xapian::valueno, map<Xapian::docid, string> >::iterator i;
    i = changes.find(slot);
    if (i == changes.end()) {
...
Xapian::docid
BrassValueManager::get_chunk_containing_did(Xapian::valueno slot,
					    Xapian::docid did,
					    string &chunk) const
{
...
void
BrassValueManager::add_document(Xapian::docid did, const Xapian::Document &doc,
...
void
BrassValueManager::delete_document(Xapian::docid did,
				   map<Xapian::valueno, ValueStats> & value_stats)
{
...
void
BrassValueManager::replace_document(Xapian::docid did,
...
string
BrassValueManager::get_value(Xapian::docid did, Xapian::valueno slot) const
{
    map<Xapian::valueno, map<Xapian::docid, string> >::const_iterator i;
    i = changes.find(slot);
    if (i != changes.end()) {
