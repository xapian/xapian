/** @file flint_replicate_internal.h
 * @brief Internal definitions for flint database replication
 */
...
#ifndef XAPIAN_INCLUDED_FLINT_REPLICATE_INTERNAL_H
#define XAPIAN_INCLUDED_FLINT_REPLICATE_INTERNAL_H
...
#endif /* XAPIAN_INCLUDED_FLINT_REPLICATE_INTERNAL_H */
