/** @file flint_databasereplicator.h
...
#ifndef XAPIAN_INCLUDED_FLINT_DATABASEREPLICATOR_H
#define XAPIAN_INCLUDED_FLINT_DATABASEREPLICATOR_H

#include "databasereplicator.h"

class FlintDatabaseReplicator : public Xapian::DatabaseReplicator {
    private:
	/** Path of database.
	 */
	std::string db_dir;
...
#endif /* XAPIAN_INCLUDED_FLINT_DATABASEREPLICATOR_H */
