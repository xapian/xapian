...
"                                    schemes: bb2weight, boolweight,\n"
/*--------------------------------------------> */
INDENT"bm25weight, dlhweight, dphweight,\n"
INDENT"ifb2weight, ineb2weight, inl2weight,\n"
INDENT"pl2weight, tfidfweight, tradweight\n"
