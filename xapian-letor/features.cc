...
map<string, long int>
Features::termfreq(const Xapian::Document & doc, const Xapian::Query & query) {
...
map<string, double>
Features::inverse_doc_freq(const Xapian::Database & db, const Xapian::Query & query) {
...
map<string, long int>
Features::doc_length(const Xapian::Database & db, const Xapian::Document & doc) {
...
map<string, long int>
Features::collection_length(const Xapian::Database & db) {
    map<string, long int> len;
...
map<string, long int>
Features::collection_termfreq(const Xapian::Database & db, const Xapian::Query & query) {
    map<string, long int> tf;
...
double
Features::calculate_f1(const Xapian::Query & query, map<string, long int> & tf, char ch) {
    double value = 0;
...
double
Features::calculate_f2(const Xapian::Query & query, map<string, long int> & tf, map<string, long int> & doc_len, char ch) {
    double value = 0;
...
double
Features::calculate_f3(const Xapian::Query & query, map<string, double> & idf, char ch) {
    double value = 0;
...
double
Features::calculate_f4(const Xapian::Query & query, map<string, long int> & tf, map<string, long int> & coll_len, char ch) {
    double value = 0;
...
double
Features::calculate_f5(const Xapian::Query & query, map<string, long int> & tf, map<string, double> & idf, map<string, long int> & doc_len, char ch) {
    double value = 0;
...
double
Features::calculate_f6(const Xapian::Query & query, map<string, long int> & tf, map<string, long int> & doc_len, map<string, long int> & coll_tf, map<string, long int> & coll_length, char ch) {
    double value = 0;
